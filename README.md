...
The pairwise Wald test comparing Stage 3 and Stage 1 reflects the transition from early biofilm formation to a mature structure. As shown in Figures 2 and 3, a large number of differentially expressed genes indicates substantial transcriptional reprogramming across development. Genes expressed at higher levels in Stage 3 were enriched for mitochondrial organization and respiration, as shown in Figure 5. KEGG pathway analysis further demonstrated enrichment of ribosome, proteasome, oxidative phosphorylation, and citrate cycle pathways in Stage 3, as shown in Figure 6, suggesting increased respiratory activity and protein turnover in mature biofilms.

Conversely, genes associated with glycolysis/gluconeogenesis, pyruvate metabolism, fatty acid metabolism, and organic acid metabolism were downregulated in Stage 3 relative to Stage 1, as shown in Figures 5 and 6, indicating that early-stage biofilms rely more heavily on fermentative and central carbon metabolism. This pattern aligns with flor yeast biofilm development during sherry wine aging, where early growth transitions to a respiration-dominated mature biofilm at the air–liquid interface [1]. Similar metabolic shifts have been reported in microbial biofilms [23], and biofilm formation in _Saccharomyces cerevisiae_ is recognized as a multi-stage developmental process [24]. The enrichment of carbohydrate metabolism in early stages is also consistent with prior transcriptomic studies [25], while proteomic analyses of flor yeast have demonstrated increased abundance of TCA cycle and respiratory proteins during biofilm maturation [26]. Together, these findings indicate a developmental shift from growth-associated metabolism to oxidative and maintenance-related processes.

#### LRT DGE and Enrichment
To capture genes changing across all stages, a likelihood ratio test (LRT) was performed [22]. Clustering of LRT-significant genes revealed clear temporal patterns, as shown in Figure 4, with Cluster 1 genes highest in Stage 1 and decreasing over time, and Cluster 3 genes progressively increasing toward Stage 3.

GO over-representation analysis of Cluster 1 revealed enrichment for monocarboxylic acid metabolic process and purine-containing compound catabolic process, as shown in Figure 7A. KEGG analysis further identified glycolysis/gluconeogenesis, carbon metabolism, and biosynthesis of secondary metabolites in Cluster 1, as shown in Figure 8A. These results reinforce that early biofilm development is characterized by active central carbon metabolism and nucleotide turnover [23, 25].

In contrast, GO enrichment of Cluster 3 showed carbohydrate metabolic process, generation of precursor metabolites and energy, energy derivation by oxidation of organic compounds, and mitochondrion organization, as shown in Figure 7B. KEGG pathways, including oxidative phosphorylation and proteasome, were enriched in Cluster 3, as shown in Figure 8B. The increasing expression of these pathways supports enhanced respiration and protein quality control during biofilm maturation [1, 24, 26], further indicating stage-dependent physiological adaptation.

#### GSEA LRT 
To evaluate coordinated pathway-level regulation, GSEA was performed using genes ranked by LRT statistics. The top enriched GO pathway was carbohydrate metabolic process, as shown in Figure 9, with a normalized enrichment score of 1.40 and an adjusted p-value of 1.04 × 10⁻⁶. KEGG GSEA identified biosynthesis of secondary metabolites as the most significantly enriched pathway, as shown in Figure 10, with a normalized enrichment score of 1.38 and an adjusted p-value of 1.07 × 10⁻⁸. Additional enriched KEGG pathways included glycolysis/gluconeogenesis, pyruvate metabolism, carbon metabolism, and the citrate cycle, confirming coordinated regulation of central carbon metabolism during biofilm progression [23, 24]. These findings are consistent with transcriptomic studies of _Saccharomyces cerevisiae_ biofilms, which report activation of carbohydrate metabolism during development [25]. Core enrichment genes such as YMR105C (PGM2) [27], which is involved in gluconeogenesis and trehalose biosynthesis during biofilm formation [25], further support the biological relevance of carbohydrate metabolic pathway enrichment. Overall, the GSEA results strengthen the ORA findings and demonstrate coordinated metabolic remodeling across biofilm development.
